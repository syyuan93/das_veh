...
from utils import XCORR_vshot, plot_xcorr, Dispersion, XCORR_two_traces, extrap1d
...
class VirtualShotGather:
    ...
    def plot_image(self, fig_name=None, fig_dir="/net/brick6/data5/syyuan/time_lapse_imaging/Fig/virtual_gathers/",  x_lim=None, norm=False, plot_disp=False, plot_kwargs={}, **kwargs):
        if x_lim is None:
            x_lim = [-200, 200]
        if not plot_disp:
            ax = kwargs.get('ax')
